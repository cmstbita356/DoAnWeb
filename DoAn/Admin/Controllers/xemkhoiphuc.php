<?php
    ...
    $ListProduct = $pm->getProductListLimitedDeleted($from, $pagesize); 
    echo
    "
    ...
    foreach($ListProduct as $Product)
    {
        ...
        "
                ...
                <td style='text-align: center; width: 200px;'>
                    <a href='../Controllers/xulykhoiphuc.php?id=".$Product->getid()."'>Khôi phục</a>
                </td>
                </tr>
        ";
    }
    echo "</table>";
    $total = ceil($pm->CountDeleted()/$pagesize);
    echo "
