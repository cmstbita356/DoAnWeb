    ...
    foreach($ListProduct as $Product)
    {
        ...
        "
                ...
                <td style='text-align: center; width: 200px;'>
                    ...
                    <a href='suasanpham.php?id=".$Product->getid()."&name=$Product->name&price=$Product->price&desc=$Product->desc&img=$Product->img&brand=$Product->brand&time=$Product->time'>Sửa</a><br>
