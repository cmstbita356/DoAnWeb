                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <select class="form-control form-control-lg select" style="font-size: 17px; height: 50px;  margin-top: 5px">
                                        ...
                                        <option value="2">Xe cũ</option>
                                        <option value="3">Xe mới</option>
                                    </select>
                                </div>
                                <div class="col-md-4 col-12">
                                    <select class="form-control form-control-lg select" style="font-size: 17px; height: 50px; margin-top: 5px" >
                                ...
                                <div class="col-md-12 col-12" id="col-select" style="align-items: center;">
                                    <input type="submit" id="select-button-banner" value="Tìm kiếm nâng cao" style="background-color: #D5A116; color: white">
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="section" style="color: black;">
                <nav aria-label="breadcrumb" style="font-size: 20px; margin-top: 20px">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Sản phẩm mua nhiều</a></li> 
                    </ol>
                </nav>
                ...
                <div style="text-align: center; margin-top: 30px; ">
                    <button class="btn btn-primary" style="font-size: 30px;">Xem tất cả</button>
                </div>
